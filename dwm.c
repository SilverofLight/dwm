...
void setup(void)
{
	...
	/* init appearance */
	unsigned int alphas_default[3] = {OPAQUE, baralpha, borderalpha};
	scheme = ecalloc(LENGTH(colors) + 1, sizeof(Clr *));
	scheme[LENGTH(colors)] = drw_scm_create(drw, colors[0], alphas_default, 3);
...
void togglewudao(const Arg *arg)
{
	Client *c;
